...
window.PROJECTS = [
  // ───────────── Author ─────────────
  {
    ...
    slug: "seen",
    name: "seen",
    tagline: "A private film diary, with recommendations grounded in what you've watched.",
    role: "Author",
    year: "2026",
    type: "Film · Web App",
    ...
    images: [
      { src: "assets/screenshots/seen/library.webp", pos: "top", c: "linear-gradient(135deg,#201933,#5436ce)", label: "Library · viewing history" },
      { src: "assets/screenshots/seen/home.webp", pos: "top", c: "linear-gradient(135deg,#201933,#ccb8fb)", label: "Home · explained recommendations" },
    ],
    what: "A record of the films you've watched, with ratings, memories, rewatches and dates that can be exact or approximate. Filter your library by genre, decade, director or tag, browse a poster wall to log older viewings, and bring in your history from Letterboxd or IMDb. Recommendations explain their connection to your own viewing history instead of presenting an unexplained list.",
    architecture: "A Next.js App Router app with server components by default. Domain modules in lib/recommendations, lib/tmdb and lib/supabase separate recommendation logic, film metadata and persistence. Supabase/Postgres uses row-level security, with TanStack Query and Virtual supporting client-side data access and long lists, and Vercel cron handling scheduled work.",
    designSystem: "A custom tokenized design system with colors and visual tokens defined through CSS custom properties. Light and dark themes are designed separately, with surfaces and contrast tuned for each. Accessibility and legibility guide the palette and component decisions.",
    why: "The diary preserves uncertainty: a viewing can belong to a year, a rough memory or an unknown date without inventing a precise timestamp. The recommendation engine follows the same principle of showing its reasoning, connecting suggestions to directors, decades and films already in your archive.",
  },
  {
    id: "mori",
    slug: "mori",
    name: "Mori",
    tagline: "Bring your Anki decks to the browser and review with FSRS scheduling.",
    role: "Author",
    year: "2026",
    type: "Learning · Full Stack",
    stack: ["Next.js 15", "TypeScript", "Tailwind CSS v4", "FastAPI", "SQLAlchemy async", "Alembic", "ARQ", "Redis", "PostgreSQL", "Docker Compose", "MinIO", "FSRS", "KaTeX", "IndexedDB · Dexie"],
    repo: "https://github.com/abouguri/Mori",
    live: "https://mori-web-eight.vercel.app",
    icon: "assets/icons/projects/mori.svg",
    position: { x: 260, y: 125 },
    images: [
      { src: "assets/screenshots/mori/decks.webp", pos: "top", c: "linear-gradient(135deg,#003a0b,#366b27)", label: "Decks · nested library" },
      { src: "assets/screenshots/mori/review.webp", pos: "top", c: "linear-gradient(135deg,#003a0b,#a5e119)", label: "Review · FSRS scheduling" },
    ],
    what: "Import Anki .apkg decks with their notes, templates, media and scheduling history, then review them in a browser. Nested decks keep the library organized, FSRS schedules reviews, and the card renderer supports cloze deletions and KaTeX math. IndexedDB/Dexie buffers review activity during connection interruptions.",
    architecture: "A multi-service app with a Next.js web frontend, an async FastAPI/SQLAlchemy API, an ARQ worker, PostgreSQL, Redis and S3-compatible object storage through MinIO. Docker Compose brings the services together, and Alembic manages database migrations. The monorepo shares a card-rendering package between previews and reviews; deck imports and FSRS optimization run as background jobs.",
    designSystem: "Tailwind CSS v4 provides consistent frontend styling, supported by CSS tokens for the deep-green and lime palette and Inter typography. Review ratings retain distinct colors so each answer is easy to recognize. These are application styles and shared tokens, rather than a separately named design-system package.",
    why: "Importing a large deck and tuning a review schedule can outlast an HTTP request, so both run in workers. A shared renderer keeps card previews and actual reviews consistent, while sandboxed card content and offline review buffering address the practical details of using imported decks in a browser.",
  },
  {
    id: "quanta",
    slug: "quanta",
